...
async function main()
{
    ...
    await slipUserResolver.resolve(db);
...
function processContributions(db)
{
    ...
    const outputTable = generateUserTable(db, [
        ...
        },
        {
            ...
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'intro').attributes.status;
            }
        },
        {
            header: 'Intro Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'intro').attributes.slips;
            }
        },
        {
            header: 'Week 1 Status',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[1]').attributes.status;
            }
        },
        {
            header: 'Week 1 Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[1]').attributes.slips;
            }
        },
        {
            header: 'Week 2 Status',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[2]').attributes.status;
            }
        },
        {
            header: 'Week 2 Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[2]').attributes.slips;
            }
        },
        {
            header: 'Week 3 Status',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[3]').attributes.status;
            }
        },
        {
            header: 'Week 3 Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[3]').attributes.slips;
            }
        },
        {
            header: 'Week 4 Status',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[4]').attributes.status;
            }
        },
        {
            header: 'Week 4 Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[4]').attributes.slips;
            }
        },
        {
            header: 'Week 5 Status',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[5]').attributes.status;
            }
        },
        {
            header: 'Week 5 Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[5]').attributes.slips;
            }
        },
        {
            header: 'Week 6 Status',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[6]').attributes.status;
            }
        },
        {
            header: 'Week 6 Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[6]').attributes.slips;
            }
        },
        {
            header: 'Week 7 Status',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[7]').attributes.status;
            }
        },
        {
            header: 'Week 7 Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[7]').attributes.slips;
            }
        },
        {
            header: 'Week 8 Status',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[8]').attributes.status;
            }
        },
        {
            header: 'Week 8 Slips',
            data(db, userID)
            {
                return AssignmentDatabase.getAssignmentByID(db, userID, 'week[8]').attributes.slips;
            }
        }
    ]);
