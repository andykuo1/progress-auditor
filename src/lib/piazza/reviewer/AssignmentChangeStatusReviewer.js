...
export async function review(db, reviewID, reviewType, reviewParams)
{
    ...
    if (!assignment) db.throwError(`Cannot find assignment for id ${assignmentID}`, { id: [reviewID, reviewType], options: [`User may not be assigned this assignment.`, `Assignment id may not exist.`] })
